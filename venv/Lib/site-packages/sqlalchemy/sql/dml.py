...
class DMLState(CompileState):
    ...
    @classmethod
    def _get_multi_service_kv_pairs(
        cls,
        statement: UpdateBase,
...
class InsertDMLState(DMLState):
    ...
    def _insert_col_keys(self) -> List[str]:
        # this is also done in crud.py -> _key_getters_for_service_column
        return [
...
class ValuesBase(UpdateBase):
    ...
    def values(
        ...
        **kwargs: Any,
        ...
        kv_generator = DMLState.get_plugin_class(self)._get_service_kv_pairs

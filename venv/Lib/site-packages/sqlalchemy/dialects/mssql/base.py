...
class MSSQLCompiler(compiler.SQLCompiler):
    ...
    def visit_table(self, table, mssql_aliased=False, isservice=False, **kwargs):
        if mssql_aliased is table or isservice:
    ...
    def delete_table_clause(self, delete_stmt, from_table, extra_froms, **kw):
        ...
        return from_table._compiler_dispatch(
            self, asfrom=True, isservice=True, ashint=ashint, **kw
        )
